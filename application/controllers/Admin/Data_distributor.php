...
class Data_distributor extends CI_Controller {
	...
	public function proses_addUser(){
		...
		if($hasil){
			echo "<script type='text/javascript'>alert('Berhasil menambahkan pengguna'); window.location.href='../data_distributor'</script>";
		}
		else
